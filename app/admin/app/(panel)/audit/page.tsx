    ...
    <>
      <tr>
        ...
        <td className="px-4 py-2.5 text-xs">
          <div className="text-ink-800">{row.actor_type}</div>
          {row.actor_id ? <div className="mono text-[10px] text-ink-500">#{row.actor_id}</div> : null}
        </td>
        <td className="px-4 py-2.5 mono text-xs text-ink-800">{row.action}</td>
        <td className="px-4 py-2.5 mono text-xs">
          {row.target_type ? (
            <>
              <div className="text-ink-800">{row.target_type}</div>
      ...
      {open && hasPayload ? (
        <tr>
          <td colSpan={7} className="bg-ink-50 px-4 py-2.5">
            <pre className="mono overflow-x-auto whitespace-pre-wrap break-all text-[11px] text-ink-500">
